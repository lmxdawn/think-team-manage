...
INSERT INTO lmx_menu ( `id`, `parent_id`, `parent_name`, `app`, `model`, `action`, `param`, `type`, `status`, `title`, `icon`, `remark`, `listorder`, `create_time`, `update_time`, `nav_id`, `is_update` ) VALUES  ('90','81','个人信息','admin','User','edit','','0','1','修改信息','fa-circle-o','','1','1488058039','1488058039','0','0');
INSERT INTO lmx_menu ( `id`, `parent_id`, `parent_name`, `app`, `model`, `action`, `param`, `type`, `status`, `title`, `icon`, `remark`, `listorder`, `create_time`, `update_time`, `nav_id`, `is_update` ) VALUES  ('91','81','个人信息','admin','User','pwd','','0','1','修改密码','fa-circle-o','','2','1488058064','1488058064','0','0');
